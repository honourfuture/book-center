...
class AliyunClient extends Client
{
    ...
    public const OCR_ADVANCED = 'https://gjbsb.market.alicloudapi.com/ocrservice/advanced
...
';
    ...
    public function advanced($images, array $options = [])
    {
        $options['_format'] = 'imgorurl';

        return $this->request(self::OCR_ADVANCED, $images, $options);
    }
}
