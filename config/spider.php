...
return [
    ...
    '69shu' => [
        'name' => '69shu',
        'charset' => 'gbk',
        'domain' => 'http://66.203.144.117/q.php?url=https://www.69shu.pro',
        'url' => 'http://66.203.144.117/q.php?url=',
        'next_url' => 'http://66.203.144.117/q.php?url=',
        'get_article_info_rule' => [
            'book_name' => ['meta:eq(11)', 'content'],
            'author' => ['meta:eq(10)', 'content'],
            'desc' => ['#intro', 'text']
        ...
        'article_url' => "http://66.203.144.117/q.php?url=https://www.69shu.pro/book/{--article_id--}/",
